...
public class AuthController {
  ...
  @GetMapping("/me")
  public Result getLoggedInUserData(Authentication authentication) {
    LOGGER.info("Authenticated user: '{}'", authentication.getName());
    return new Result(true, StatusCode.SUCCESS, "User Info",
        this.authService.getLoginInfo(authentication));
  }
